...
import { createUser } from '@/lib/api' // Import the createUser function
import { CreateUserDto } from '@/types' // Import the CreateUserDto interface
...
export function SignUpContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null)
    try {
      const userData: CreateUserDto = { email, password, name }
